"""
ROS 2 node to spawn a warehouse_robot_tutorial robot inside a warehouse.
...
def main():
    ...
    sdf_file_path = os.path.join(
        get_package_share_directory("kmou_robot_spawner_pkg"), "models",
        "warehouse_robot_tutorial", "model.sdf")
